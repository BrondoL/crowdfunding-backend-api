...
func FormatCampaignDetail(campaign Campaign) CampaignDetailFormatter {
	...
	campaignDetailFormatter.Perks = strings.Split(campaign.Perks, ",")
	for i, perk := range campaignDetailFormatter.Perks {
		campaignDetailFormatter.Perks[i] = strings.TrimSpace(perk)
	}

	campaignDetailFormatter.User.Name = campaign.User.Name
	campaignDetailFormatter.User.ImageURL = campaign.User.AvatarFileName
	...
	for _, image := range campaign.CampaignImages {
		...
		campaignDetailFormatter.Images = append(campaignDetailFormatter.Images, campaignImagesFormatter)
	}
